...
<? if ( !empty( $arResult['TAGS'] ) ) { ?>
    <div class="disk-folder-list-toolbar bx24-disk-folder-list-toolbar-tags">
        <div class="disk-breadcrumbs">
            <div class="disk-breadcrumbs-item">
                <a class="disk-breadcrumbs-item-title" href="#" data-object-id="1"><?= Loc::getMessage('DISK_FOLDER_LIST_TAGS_TITLE')?>:</a>
                <span class="disk-breadcrumbs-item-arrow"></span>
            </div>
            <? foreach ( $arResult['TAGS'] as $arItem ) { ?>
                <div class="disk-breadcrumbs-item">
                    <a class="disk-breadcrumbs-item-title " href="<?= BX24\Disk\Tags::GetLinkFilterTag($arItem['NAME']) ?>"><?= $arItem['NAME'] ?></a>
                    <span class="disk-breadcrumbs-item-arrow"></span>
                </div>
            <? } ?>
        </div>
