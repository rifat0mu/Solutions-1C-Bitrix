...
?><div class="socialnetwork-group-sidebar-block">
	...
	<table cellspacing="0" class="socialnetwork-group-layout">
        ...
        if ( is_array($arResult["Group"]["DISK_TAGS"]) && !empty($arResult["Group"]["DISK_TAGS"]) ) {
            ?><tr class="socialnetwork-group-layout-row">
            <td class="socialnetwork-group-layout-left-column"><?=Loc::getMessage("SONET_DISK_TAGS_TITLE")?>:</td>
            <td class="socialnetwork-group-layout-right-column">
                <div class="socialnetwork-group-sidebar-tag-box"><?
                    foreach($arResult["Group"]["DISK_TAGS"] as $arItem) { ?>
                        <a bx-tag-value="" href="<?= BX24\Disk\Tags::GetLinkFilterTag($arItem['NAME']) ?>" class="socialnetwork-group-sidebar-tag"><?=$arItem['NAME']?></a>
                    <? } ?>
                </div>
            </td>
            </tr><?
