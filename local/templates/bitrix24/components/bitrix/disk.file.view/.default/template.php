...
<div class="disk-detail">
	...
	<div class="disk-detail-sidebar">
        ...
        <div class="disk-detail-sidebar-section">
            <div class="disk-detail-sidebar-user-access-title disk-detail-sidebar-owner-title-double">
                <div class="disk-detail-sidebar-user-access-title-text"><?= Loc::getMessage('DISK_FILE_VIEW_TAGS_TITLE') ?>:</div>
                <div class="disk-detail-sidebar-user-access-title-add" id="disk-tags-add"><?= Loc::getMessage('DISK_FILE_VIEW_TAGS_ADD') ?></div>
            </div>

            <?php include 'bx24_tags.php'; ?>
        </div>
